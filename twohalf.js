...
*/
	...
	*/
	...
	function optionsFennecYiff(str){
		switch (str) {
			case 'бандаж':
				println('Самка фенника берёт в лапу телефон и выбирает, как сегодня хочет развлечься.	Вскоре после выбора слышится звук открывающейся двери и входит самец гепард с верёвкой в лапах. самец сделав с верёвки небольшое лассо накидывает его на лапу самки и лёгким движением на себя затягивает лассо на запястье лапы фенника. затянув лассо самец слегка тянет самку к себе и подходит. Приблизившись самец переворачивает самку на живот и заводит лапы самки за спину и связывает передние лапы вместе. улыбнувшись гепард начинает снимать с самки трусы и залезает на самку сверху. самец тянет немного за верёвку на себя и сближается своим пахом с попкой самки. самец уложил свой член между ягодиц самки и медленным движением потерается членом о попку и вскоре выдаёт щедрую порцию смазки на колечко и основание хвостика. самец навис над самкой и левой лапой держит верёвку а правой направляет член в попку самки. Гепард горячо дышит над ушком и активно имеет самку в колечко и вскоре кончает и Развязывает лапы а также уходит снова в дверь. ');
				setHyperText ([ 'Далее' ]);
				setHyperTitle ([ 'Далее' ]);
			break;
			case 'далее':
	...
	/*
	миниигра поездка на члене, скорость, сила сжатия, размер колечка, кончил внутрь или на спину, доволен или не доволен.
	*/
