...
*/
	...
	*/ 
	...
	var arrEH = [true];
	var arrHTT1 = ['Переидти', 'Персонажи', 'Шен']; //['Переидти', 'Алон', '5 кг', '10 кг', 'Отдых', 'Спорт', 'Самца', 'Телефон', 'Персонажи'];
	var arrHTE1 = ['Переидти', 'Персонажи', 'Шен']; //['Переидти', 'Играться с Алоном', 'Дать 5 кг еды', 'Дать 10 кг еды', 'Отдых', 'Спорт', 'Дать льву самца ', ' ', ' '];
	var arrHTT2 = ['Переидти', 'Персонажи', 'Шен']; //['Переидти', 'Алон', '5 кг', '10 кг', 'Отдых', 'Спорт', 'Самца', 'Телефон', 'Персонажи'];
	var arrHTE2 = ['Переидти', 'Персонажи', 'Шен']; //['Переидти', 'Играться с Алоном', 'Дать 5 кг еды', 'Дать 10 кг еды', 'Отдых', 'Спорт', 'Дать льву самца ', ' ', ' '];
	var inputValue;
		...
		switch (str) {
			case 'переидти':
				...
				switch (playerPosition) {
					...
					break;
					case 'зал':
						setHyperText (['Кухня', 'Коридор', 'Туалет', 'Назат']);
						setHyperTitle (['Кухня', 'Коридор', 'Туалет', 'Назат']);
					break;
				}
			break;
			case 'персонажи':
	...
	function shen(str){
		switch (str) {
			case 'шен':
				...
				setHyperText (['Осмотреть шена', 'Всё ок шен, я закончил' ]);
				setHyperTitle (['Осмотреть шена', 'Всё ок шен, я закончил' ]);
			break; 
			case 'осмотреть шена':
				...
				setHyperText (['Осмотреть шена', 'А что в тусах шен?', 'Всё ок шен, я закончил' ]);
				setHyperTitle (['Осмотреть шена', 'А что в тусах шен?', 'Всё ок шен, я закончил' ]);
			break;
			case 'а что в тусах шен?':
				println('член кажется 9 сантиметров и не возбуждён (15 сантиметров возбуждённый.) \nЯички кажется 3 сантиметра каждое. ');
			break;
